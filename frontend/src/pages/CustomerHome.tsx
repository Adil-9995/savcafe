      ...
      <main className="flex-grow max-w-6xl w-full mx-auto px-6 py-16 space-y-16">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-3">
          ...
          <p className="text-xs md:text-sm text-savora-text-secondary leading-relaxed">
            For years, Savora has been Kochi's favorite spot for fresh oven bakes and real dairy ice creams. We source local farm cream, real vanilla extract, and high-quality chocolate to create memorable dessert moments.
          </p>
        </div>
